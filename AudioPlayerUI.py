...
class Ui_AudioPlayerDemo(object):
    def setupUi(self, AudioPlayerDemo):
        AudioPlayerDemo.setObjectName("MP3 player")
        AudioPlayerDemo.resize(660, 500)
        self.centralWidget = QtGui.QWidget(AudioPlayerDemo)
        self.centralWidget.setObjectName("centralWidget")
        self.label = QtGui.QLabel(self.centralWidget)
        self.label.setGeometry(QtCore.QRect(0, 0, 660, 280))
        self.label.setStyleSheet("background: url(\"mp3lo.png\")")
        self.label.setText("")
    ...
    def retranslateUi(self, AudioPlayerDemo):
        AudioPlayerDemo.setWindowTitle(QtGui.QApplication.translate("AudioPlayerDemo", "MP3 player", None, QtGui.QApplication.UnicodeUTF8))
